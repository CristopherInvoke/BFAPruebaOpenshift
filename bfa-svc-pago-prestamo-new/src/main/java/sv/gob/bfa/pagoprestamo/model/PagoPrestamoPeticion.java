...
public class PagoPrestamoPeticion extends Peticion{
	...
	public String toString() {
		return "PagoPrestamoPeticion [codTran=" + codTran + ", numDocumentoTran=" + numDocumentoTran
				+ ", cuentaPrestamo=" + cuentaPrestamo + ", senSupervisor=" + senSupervisor + ", codTerminal="
				+ codTerminal + ", valorMovimiento=" + valorMovimiento + ", tipDocumentoPersona=" + tipDocumentoPersona
				+ ", numDocumentoPersona=" + numDocumentoPersona + ", nombrePersona=" + nombrePersona
				+ ", numTransLavado=" + numTransLavado + ", valorEfectivo=" + valorEfectivo + ", valorCheques="
				+ valorCheques + ", valorChequesPropios=" + valorChequesPropios + ", valorChequesAjenos="
				+ valorChequesAjenos + ", codOficinaTran=" + codOficinaTran + ", codCajero=" + codCajero + ", numCaja="
				+ numCaja + ", cheques=" + cheques + "]";
	}
